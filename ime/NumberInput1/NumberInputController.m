...
// This method converts buffered text based on the trigger string.  
// If we did convert the text previously insert the converted text with the trigger string appended to the converted text.  
